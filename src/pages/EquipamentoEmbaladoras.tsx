...
const EquipamentoEmbaladoras = () => {
  ...
  const { modelos } = useEquipamentoCatalogo("embaladoras");
  const { content: catalogo } = useSiteContent("catalogo_embaladoras");
      ...
      >
        <div className="relative z-10 mx-auto max-w-5xl px-4 text-center md:px-6 lg:px-8">
          <h2 className="mb-4 text-3xl font-extrabold text-gray-200 lg:text-4xl">
            {eq.cta_cat_titulo ?? "Interessado em embaladoras?"}
          </h2>
          ...
          <div className="flex justify-center">
            <button
              ...
              onClick={() =>
                window.open(
                  "https://wa.me/5547984218275?text=" +
                    encodeURIComponent("Olá, gostaria de um orçamento para Embaladoras!"),
                  "_blank"
                )
              }
            >
...
export default EquipamentoEmbaladoras;
