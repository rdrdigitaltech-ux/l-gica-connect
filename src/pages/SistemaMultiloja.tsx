    ...
    <div className="min-h-screen bg-[#0A0C10]">
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              ...
              <button
                type="button"
                onClick={() => window.open(cms.func_link || "https://wa.me/5547984218275?text=" + encodeURIComponent("Olá! Tenho interesse no Sistema Multiloja / ERP. Gostaria de falar com um especialista sobre funcionalidades, valores e implantação."), "_blank")}
      ...
      <section className="relative overflow-hidden py-20" style={{ background: "#0A0C10" }}>
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center md:px-6 lg:px-8">
          ...
          <button
            type="button"
            onClick={() => window.open(cms.cta_link || "https://wa.me/5547984218275?text=" + encodeURIComponent("Olá! Tenho interesse no Sistema ERP Multi-Loja da Lógica. Gostaria de saber mais sobre gestão centralizada, integração entre filiais, valores e implantação."), "_blank")}
          ...
          >
            ...
            {cms.cta_btn || "Falar com Especialista em Multiloja"}
          </button>
        </div>
      </section>
    </div>
