...
export default function SistemaVarejo() {
  return (
    <div className="min-h-screen bg-[#0A0C10]">
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/5547984218275?text=" +
                      encodeURIComponent(
                        "Olá! Tenho interesse no Sistema para Comércio & Varejo. Gostaria de falar com um especialista sobre funcionalidades, valores e implantação."
                      ),
                    "_blank"
                  )
                }
            ...
            {vantagens.map((item) => {
              ...
              return (
                ...
                >
                  ...
                  />
                  {/* Glow no hover - canto superior esquerdo */}
                  <div
      ...
      {/* ========== CTA WHATSAPP ESPECÍFICO - VAREJO ========== */}
            ...
            <button
              ...
              onClick={() =>
                window.open(
                  "https://wa.me/5547984218275?text=" +
                    encodeURIComponent(
                      "Olá! Tenho interesse no Sistema de Varejo da Lógica. Gostaria de saber mais sobre funcionalidades, valores e implantação."
                    ),
                  "_blank"
                )
              }
