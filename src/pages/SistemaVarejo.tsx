...
export default function SistemaVarejo() {
  const { content: cms } = useSiteContent("sistema_varejo");
      ...
      >
        ...
        <div className="relative z-10 mx-auto max-w-7xl px-4 md:px-6 lg:px-8">
          <nav className="mb-8 flex items-center gap-2 text-sm text-gray-500">
            ...
            <ChevronRight className="h-4 w-4" />
            <span className="text-gray-300">Comércio & Varejo</span>
          </nav>
          <div
          ...
          >
            ...
            <span className="text-xs font-bold uppercase tracking-wider text-gray-300">
              {cms.hero_badge ?? "Sistema para Comércio & Varejo"}
            </span>
          </div>
          <h1 className="mb-6 font-extrabold leading-tight text-gray-200" style={{ fontSize: "clamp(28px, 4vw, 48px)" }}>
            {cms.hero_titulo ?? <>Implantamos Softwares para Comércio & Varejo em{" "}
          ...
          <div className="grid grid-cols-1 items-center gap-12 lg:grid-cols-2">
            ...
            <div>
              <h2 className="mb-8 text-3xl font-extrabold text-gray-200 lg:text-4xl">
                {cms.seg_titulo ?? "Para quem é o software?"}
              </h2>
