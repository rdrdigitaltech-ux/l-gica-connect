...
<<<<<<< HEAD
              ...
              <div className="mb-8 grid grid-cols-1 gap-4 sm:grid-cols-2">
                {assistenciaItens.map((label) => (
                  <div key={label} className="flex items-start gap-3">
                    <div className="mt-1 flex h-6 w-6 shrink-0 items-center justify-center rounded-full" style={checkItemStyle}>
