...
const vantagens = [
  {
    icon: Settings,
    title: "Personalizado",
    desc: "Adequação de funcionalidades requeridas por qualquer tipo de loja ou negócio.",
  },
  {
    icon: Building2,
    title: "Gerenciamento",
    desc: "Permite gerenciar filiais, centralizando a gestão da empresa.",
  },
  {
    icon: FileText,
...
const segmentosImagem = {
  src: "/img/shopping-erp.webp",
...
=======
              ...
              <p className="mb-8 text-base leading-relaxed text-gray-400 lg:text-lg">
                Este software traz uma solução personalizada para cada negócio,
                por isso seu uso é considerado multiloja, buscando atender às
                ...
                onClick={() =>
                  window.open(
                    "https://wa.me/5547984218275?text=" +
                      encodeURIComponent(
                        "Olá! Tenho interesse no Sistema Multiloja / ERP. Gostaria de falar com um especialista sobre funcionalidades, valores e implantação."
                      ),
                    "_blank"
                  )
                }
...
>>>>>>> bb0eef4899aa3e3e6fbc87389bad56699407c752
      ...
      {/* ========== CTA WHATSAPP ESPECÍFICO - MULTILOJA ========== */}
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 text-center md:px-6 lg:px-8">
          <div>
            <h2 className="mb-4 text-3xl font-extrabold text-white md:text-4xl">
              Gerencie Múltiplas Lojas com Facilidade
            </h2>
            <p className="mb-8 text-lg text-gray-400">
              Entre em contato com nossa equipe especializada em ERP para redes e descubra como centralizar sua gestão.
            </p>
            <button
              type="button"
              onClick={() =>
                window.open(
                  "https://wa.me/5547984218275?text=" +
                    encodeURIComponent(
                      "Olá! Tenho interesse no Sistema ERP Multi-Loja da Lógica. Gostaria de saber mais sobre gestão centralizada, integração entre filiais, valores e implantação."
                    ),
                  "_blank"
                )
              }
